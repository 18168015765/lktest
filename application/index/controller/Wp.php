...
class Wp{
    ...
    */
    private $config = array(
        'appid' => "wx426b3015555a46be",    /*微信开放平台上的应用id*/
        'mch_id' => "1225312702",   /*微信申请成功之后邮件中的商户id*/
        'api_key' => "e10adc3949ba59abbe56e057f20f883e",    /*在微信商户平台上自己设定的api密钥 32位*/
        'notify_url' => 'www.ttt.com',
  
    );
 
    public function test(){
        $this->wxpay("lk",1,'wxzf'.time(),1,3);
    }
    ...
    */
    public function postXmlCurl($xml,$url,$second=30){  
        ...
        // curl_setopt($ch,CURLOPT_SSLCERT,'/wx/apiclient_cert.pem');
        //默认格式为PEM，可以注释
        // curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
        //退款证书
        // curl_setopt($ch,CURLOPT_SSLKEY,PUBLIC_PATH.'/wx/apiclient_key.pem');
        // curl_setopt($ch,CURLOPT_SSLKEY,'/wx/apiclient_key.pem');
